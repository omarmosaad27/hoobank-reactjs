  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full  `}>
        <div className="flex-1 justify-start flex-col mr-10">
          <img
            src={logo}
            alt="logo"
            ...
            >
              ...
              <ul>
                {footerLink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-poppins font-normal leading-[24px] cursor-pointer text-dimWhite hover:text-secondary ${
      ...
      >
        <p className="text-white font-poppins font-medium text-[18px] leading-[27px]">
